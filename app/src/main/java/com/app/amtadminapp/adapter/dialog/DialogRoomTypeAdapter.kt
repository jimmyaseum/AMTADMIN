...
import com.app.amtadminapp.model.response.booking.RoomTypeListModel
import kotlinx.android.synthetic.main.row_select.view.*
import java.util.*

class DialogRoomTypeAdapter(private val mContext: Context, private val arrData: ArrayList<RoomTypeListModel>) : RecyclerView.Adapter<DialogRoomTypeAdapter.ViewHolder>() {
