...
import kotlinx.android.synthetic.main.row_pending_hotel_voucher_report.view.*


import java.util.*

class PendingHotelVoucherReportAdapter(private val mContext: Context, private val arrData: ArrayList<PendingHotelVoucherReportModel>) : RecyclerView.Adapter<PendingHotelVoucherReportAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.row_pending_hotel_voucher_report, parent, false)
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        @RequiresApi(Build.VERSION_CODES.P)
        fun bindItems(
            model: PendingHotelVoucherReportModel,
            mContext: Context
        ) {
