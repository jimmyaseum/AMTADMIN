...
class DialogHotelNameAdapter(private val mContext: Context, private val arrData: ArrayList<HotelListModel>) : RecyclerView.Adapter<DialogHotelNameAdapter.ViewHolder>() {
