...
class DialogEmployeeAdapter(private val mContext: Context, private val arrData: ArrayList<EmployeeListModel>) : RecyclerView.Adapter<DialogEmployeeAdapter.ViewHolder>() {
