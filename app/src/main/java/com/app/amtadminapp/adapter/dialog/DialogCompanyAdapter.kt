...
class DialogCompanyAdapter(private val mContext: Context, private val arrData: ArrayList<CompanyListModel>) : RecyclerView.Adapter<DialogCompanyAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            itemView.txtName.text = model.CompanyName
