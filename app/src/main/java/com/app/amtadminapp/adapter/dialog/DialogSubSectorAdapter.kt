...
import com.app.amtadminapp.model.response.SubSectorListModel
import kotlinx.android.synthetic.main.row_select.view.*
import java.util.*

class DialogSubSectorAdapter(private val mContext: Context, private val arrData: ArrayList<SubSectorListModel>) : RecyclerView.Adapter<DialogSubSectorAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            model: SubSectorListModel,
            recyclerClickListener: RecyclerClickListener
        ) {

            itemView.txtName.text = model.SubSectorName
