...
import com.app.amtadminapp.model.response.CityModel
import kotlinx.android.synthetic.main.row_select.view.*
import java.util.*

class DialogCityAdapter(private val mContext: Context, private val arrData: ArrayList<CityModel>) : RecyclerView.Adapter<DialogCityAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            itemView.txtName.text = model.CityName
