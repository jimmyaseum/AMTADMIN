...
class ConfirmedHotelVoucherReportAdapter(private val mContext: Context, private val arrData: ArrayList<ConfirmedHotelVoucherReportModel>) : RecyclerView.Adapter<ConfirmedHotelVoucherReportAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.row_confirmed_hotel_voucher_report, parent, false)
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        @RequiresApi(Build.VERSION_CODES.P)
        fun bindItems(
            model: ConfirmedHotelVoucherReportModel,
            mContext: Context
        ) {
            ...
            if(model.HotelName != null) {
                val plainText = HtmlCompat.fromHtml(model.HotelName!!, HtmlCompat.FROM_HTML_MODE_LEGACY).toString()
                itemView.txtHotelName.text = plainText
            }
