...
import com.app.amtadminapp.model.response.booking.SpecialityTypeListModel
import kotlinx.android.synthetic.main.row_select.view.*
import java.util.*

class DialogSpecialityTypeAdapter(private val mContext: Context, private val arrData: ArrayList<SpecialityTypeListModel>) : RecyclerView.Adapter<DialogSpecialityTypeAdapter.ViewHolder>() {
