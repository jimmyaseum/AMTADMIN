...
class DialogTourDateAdapter(private val mContext: Context, private val arrData: ArrayList<DateDataModel>) : RecyclerView.Adapter<DialogTourDateAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            itemView.txtName.text = model.TourDate
