...
import com.app.amtadminapp.model.response.RelationModel
import kotlinx.android.synthetic.main.row_select.view.*
import java.util.*

class DialogRelationAdapter(private val mContext: Context, private val arrData: ArrayList<RelationModel>) : RecyclerView.Adapter<DialogRelationAdapter.ViewHolder>() {
