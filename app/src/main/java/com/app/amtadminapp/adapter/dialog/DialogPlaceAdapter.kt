...
import com.app.amtadminapp.model.response.AllCityListModel
import kotlinx.android.synthetic.main.row_select.view.*
import java.util.*

class DialogPlaceAdapter(private val mContext: Context, private val arrData: ArrayList<AllCityListModel>) : RecyclerView.Adapter<DialogPlaceAdapter.ViewHolder>() {
