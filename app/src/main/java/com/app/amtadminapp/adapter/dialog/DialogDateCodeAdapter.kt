...
class DialogDateCodeAdapter(private val mContext: Context, private val arrData: ArrayList<DateDataModel>) : RecyclerView.Adapter<DialogDateCodeAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            itemView.txtName.text = model.TourDateCode
