...
import kotlinx.android.synthetic.main.row_pending_form_list.view.*
import kotlinx.android.synthetic.main.row_pending_form_list.view.LL_More
import kotlinx.android.synthetic.main.row_pending_form_list.view.card
import kotlinx.android.synthetic.main.row_pending_form_list.view.txtBookBy
import kotlinx.android.synthetic.main.row_pending_form_list.view.txtBranch
import kotlinx.android.synthetic.main.row_pending_form_list.view.txtMobileNo
import kotlinx.android.synthetic.main.row_pending_form_list.view.txtName
import kotlinx.android.synthetic.main.row_pending_form_list.view.txtNoOfNights
import kotlinx.android.synthetic.main.row_pending_form_list.view.txtReadLess
import kotlinx.android.synthetic.main.row_pending_form_list.view.txtReadMore
import kotlinx.android.synthetic.main.row_pending_form_list.view.txtSector
import kotlinx.android.synthetic.main.row_pending_form_list.view.txtTour
import kotlinx.android.synthetic.main.row_pending_form_list.view.txtTourBokingNo
import kotlinx.android.synthetic.main.row_pending_form_list.view.txtTourDateCode
import kotlinx.android.synthetic.main.row_pending_form_list.view.txtTourStartDate
import kotlinx.android.synthetic.main.row_pending_form_list.view.txtTravelType
import java.util.*

class PendingFormListAdapter(private val mContext: Context, private val arrData: ArrayList<PendingFormListModel>) : RecyclerView.Adapter<PendingFormListAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.row_pending_form_list, parent, false)
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            if(model.BookingStep != null) {
                itemView.txtPendingStepFrom.text = model.BookingStep
            }
