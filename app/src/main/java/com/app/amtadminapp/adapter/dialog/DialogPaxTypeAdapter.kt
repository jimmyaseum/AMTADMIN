...
class DialogPaxTypeAdapter(private val mContext: Context, private val arrData: ArrayList<PaxTypeListModel>) : RecyclerView.Adapter<DialogPaxTypeAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            model: PaxTypeListModel,
            recyclerClickListener: RecyclerClickListener
        ) {

            itemView.txtName.text = model.PaxType
