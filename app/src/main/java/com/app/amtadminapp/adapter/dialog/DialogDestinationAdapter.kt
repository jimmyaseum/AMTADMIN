...
import com.app.amtadminapp.model.response.booking.DestinationListModel
import kotlinx.android.synthetic.main.row_select.view.*
import java.util.*

class DialogDestinationAdapter(private val mContext: Context, private val arrData: ArrayList<DestinationListModel>) : RecyclerView.Adapter<DialogDestinationAdapter.ViewHolder>() {
