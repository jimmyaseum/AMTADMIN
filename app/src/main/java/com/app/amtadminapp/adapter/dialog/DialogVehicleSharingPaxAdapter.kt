...
import com.app.amtadminapp.model.response.booking.VehicleSharingListModel
import kotlinx.android.synthetic.main.row_select.view.*
import java.util.*

class DialogVehicleSharingPaxAdapter(private val mContext: Context, private val arrData: ArrayList<VehicleSharingListModel>) : RecyclerView.Adapter<DialogVehicleSharingPaxAdapter.ViewHolder>() {
