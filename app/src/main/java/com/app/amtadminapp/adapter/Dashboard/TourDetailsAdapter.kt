...
class TourDetailsAdapter(private val mContext: Context, private val arrData: ArrayList<HotelVoucherListModel>) : RecyclerView.Adapter<TourDetailsAdapter.ViewHolder>() {
