...
import com.app.amtadminapp.model.response.HotelListModel
import com.app.amtadminapp.model.response.TourPackageListModel
import kotlinx.android.synthetic.main.row_select.view.*
import java.util.*

class DialogHotelBlockAdapter(private val mContext: Context, private val arrData: ArrayList<HotelListModel>) : RecyclerView.Adapter<DialogHotelBlockAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            itemView.txtName.text = model.HotelName
