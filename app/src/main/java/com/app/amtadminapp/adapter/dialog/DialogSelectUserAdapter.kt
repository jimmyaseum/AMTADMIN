...
import com.app.amtadminapp.model.response.SelectUserModel
import kotlinx.android.synthetic.main.row_select.view.*
import java.util.*

class DialogSelectUserAdapter(private val mContext: Context, private val arrData: ArrayList<SelectUserModel>) : RecyclerView.Adapter<DialogSelectUserAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            itemView.txtName.text = model.EmployeeName
