...
class DialogTourPackageAdapter(private val mContext: Context, private val arrData: ArrayList<TourPackageListModel>) : RecyclerView.Adapter<DialogTourPackageAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            model: TourPackageListModel,
            recyclerClickListener: RecyclerClickListener
        ) {

            itemView.txtName.text = model.TourName
