...
class DialogRoomCategoryAdapter(private val mContext: Context, private val arrData: ArrayList<RoomCategoryListModel>) : RecyclerView.Adapter<DialogRoomCategoryAdapter.ViewHolder>() {
