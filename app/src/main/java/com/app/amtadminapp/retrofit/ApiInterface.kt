...
interface ApiInterface {
    ...
    @POST("tourbooking/pendingpaymentreport")
    fun getPendingPaymentDetails(@Body body: RequestBody?): Call<PendingPaymentReportResponse>

    @POST("TourBookingReport/VehicleAllotmentReport")
    fun getVehicleAllotmentDetails(@Body body: RequestBody?): Call<VehicleAllotmentReportResponse>

    @POST("RouteBooking/PendingRouteList")
    fun getPendingRouteVoucherDetails(@Body body: RequestBody?): Call<PendingRouteVoucherReportResponse>

    @POST("HotelBooking/PendingHotelVoucherList")
    fun getPendingHotelVoucherDetails(@Body body: RequestBody?): Call<PendingHotelVoucherReportResponse>

    @POST("TourBookingReport/VoucherHotelReport")
    fun getConfirmedHotelVoucherDetails(@Body body: RequestBody?): Call<ConfirmedHotelVoucherReportResponse>

    @POST("TourBookingReport/BookingHotelReport")
    fun getConfirmedBookingDetails(@Body body: RequestBody?): Call<ConfirmedBookingReportResponse>

    @POST("TourBookingReport/branchwisetourbookingsummaryreport")
    fun getBranchWiseBookingDetails(@Body body: RequestBody?): Call<BranchWiseTourBookingSummaryReportResponse>

    @POST("employee/EmployeeByBranchID")
    fun getSelectUser(@Body body: RequestBody?): Call<SelectUserResponse>

    @POST("TourBookingReport/UserWiseTourBookingReport")
    fun getUserWiseTourBookingDetails(@Body body: RequestBody?): Call<UserWiseTourBookingReportResponse>

    @POST("TourBookingReport/SelfTourBookingReport")
    fun getSelfTourBookingDetails(@Body body: RequestBody?): Call<SelfTourBookingReportResponse>
