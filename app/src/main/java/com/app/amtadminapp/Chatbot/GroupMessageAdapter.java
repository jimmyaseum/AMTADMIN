...
public class GroupMessageAdapter extends RecyclerView.Adapter<GroupMessageAdapter.MessageViewHolder>
{
    ...
    public class MessageViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView receiver_message_text , receiver_date_time , sender_message_text , sender_date_time, receiver_message_name;
        ...
        public MessageViewHolder(View itemView) {
            ...
            receiver_message_name = itemView.findViewById(R.id.receiver_message_name);
    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.receiver_message_name.setVisibility(View.VISIBLE);
        holder.receiver_message_name.setText(messages.getName());
