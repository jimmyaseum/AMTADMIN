...
import kotlinx.android.synthetic.main.activity_route_voucher_list_filter.*
import kotlinx.android.synthetic.main.activity_route_voucher_list_filter.edtBookBy
import kotlinx.android.synthetic.main.activity_route_voucher_list_filter.edtBranch
import kotlinx.android.synthetic.main.activity_route_voucher_list_filter.edtSector
import kotlinx.android.synthetic.main.activity_route_voucher_list_filter.edtTour
import kotlinx.android.synthetic.main.activity_route_voucher_list_filter.edtTourDateCode
import kotlinx.android.synthetic.main.activity_route_voucher_list_filter.tvApply
import kotlinx.android.synthetic.main.activity_route_voucher_list_filter.tvClearAll
import kotlinx.android.synthetic.main.activity_route_voucher_list_filter.tvClose
import kotlinx.android.synthetic.main.activity_route_voucher_list_filter.tvFilters
...
class RouteVoucherListFilterActivity  : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_route_voucher_list_filter)
        getIntentData()
        initializeView()
    }
        ...
        edtSearchCustomer.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(char: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                if (char.toString().trim().isNotEmpty()) {
                    ...
                    val itemAdapter = DialogSectorAdapter(this@RouteVoucherListFilterActivity, arrItemsFinal1)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
                    ...
                    val itemAdapter = DialogSectorAdapter(this@RouteVoucherListFilterActivity, arrayListSector!!)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
        ...
        edtSearchCustomer.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(char: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                if (char.toString().trim().isNotEmpty()) {
                    ...
                    val itemAdapter = DialogTourPackageAdapter(this@RouteVoucherListFilterActivity, arrItemsFinal1)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
                    ...
                    val itemAdapter = DialogTourPackageAdapter(this@RouteVoucherListFilterActivity, arrayListTourPackage!!)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
        ...
        edtSearchCustomer.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(char: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                if (char.toString().trim().isNotEmpty()) {
                    ...
                    val itemAdapter = DialogEmployeeAdapter(this@RouteVoucherListFilterActivity, arrItemsFinal1)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
                    ...
                    val itemAdapter = DialogEmployeeAdapter(this@RouteVoucherListFilterActivity, arrayListEmployee!!)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
