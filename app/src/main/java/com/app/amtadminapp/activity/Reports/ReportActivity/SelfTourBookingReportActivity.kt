...
import com.app.amtadminapp.activity.Reports.ReportView.SelfTourBookingReportViewActivity
...
import kotlinx.android.synthetic.main.activity_self_tour_booking_report.*
import kotlinx.android.synthetic.main.activity_self_tour_booking_report.CardGetDetail
import kotlinx.android.synthetic.main.activity_self_tour_booking_report.edtDateType
import kotlinx.android.synthetic.main.activity_self_tour_booking_report.edtFromDate
import kotlinx.android.synthetic.main.activity_self_tour_booking_report.edtToDate
import kotlinx.android.synthetic.main.activity_self_tour_booking_report.imgBack
import kotlinx.android.synthetic.main.activity_self_tour_booking_report.imgclearDT
import kotlinx.android.synthetic.main.activity_self_tour_booking_report.imgclearFD
import kotlinx.android.synthetic.main.activity_self_tour_booking_report.imgclearTD
import kotlinx.android.synthetic.main.activity_self_tour_booking_report.tbTvTitle
...
class SelfTourBookingReportActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_self_tour_booking_report)
        initializeView()
    }
...
//        id = intent.extras!!.getString("CustomerID").toString()
        Log.d("Hello==>",""+userId)
...
//                dpd.datePicker.maxDate = System.currentTimeMillis() - 1000
            ...
            R.id.CardGetDetail -> {
                val intent = Intent(this, SelfTourBookingReportViewActivity::class.java)
