...
import kotlinx.android.synthetic.main.activity_tour_booking_filter.*
import kotlinx.android.synthetic.main.activity_tour_booking_filter.edtBookBy
import kotlinx.android.synthetic.main.activity_tour_booking_filter.edtBranch
import kotlinx.android.synthetic.main.activity_tour_booking_filter.edtMobileNo
import kotlinx.android.synthetic.main.activity_tour_booking_filter.edtName
import kotlinx.android.synthetic.main.activity_tour_booking_filter.edtNoOfNights
import kotlinx.android.synthetic.main.activity_tour_booking_filter.edtSector
import kotlinx.android.synthetic.main.activity_tour_booking_filter.edtTour
import kotlinx.android.synthetic.main.activity_tour_booking_filter.edtTourBookingNo
import kotlinx.android.synthetic.main.activity_tour_booking_filter.edtTourDateCode
import kotlinx.android.synthetic.main.activity_tour_booking_filter.edtTravelType
import kotlinx.android.synthetic.main.activity_tour_booking_filter.tvApply
import kotlinx.android.synthetic.main.activity_tour_booking_filter.tvClearAll
import kotlinx.android.synthetic.main.activity_tour_booking_filter.tvClose
import kotlinx.android.synthetic.main.activity_tour_booking_filter.tvFilters
...
class TourBookingFilterActivity  : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tour_booking_filter)
        getIntentData()
        initializeView()
    }
    ...
    private fun getIntentData() {
        ...
        if (intent.hasExtra("GroupBooking")) {
            GroupBooking = intent.getStringExtra("GroupBooking").toString()
            edtGroupBooking.setText(GroupBooking)
        }
        ...
        edtSearchCustomer.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(char: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                if (char.toString().trim().isNotEmpty()) {
                    ...
                    val itemAdapter = DialogSectorAdapter(this@TourBookingFilterActivity, arrItemsFinal1)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
                    ...
                    val itemAdapter = DialogSectorAdapter(this@TourBookingFilterActivity, arrayListSector!!)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
        ...
        edtSearchCustomer.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(char: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                if (char.toString().trim().isNotEmpty()) {
                    ...
                    val itemAdapter = DialogTourPackageAdapter(this@TourBookingFilterActivity, arrItemsFinal1)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
                    ...
                    val itemAdapter = DialogTourPackageAdapter(this@TourBookingFilterActivity, arrayListTourPackage!!)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
        ...
        edtSearchCustomer.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(char: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                if (char.toString().trim().isNotEmpty()) {
                    ...
                    val itemAdapter = DialogEmployeeAdapter(this@TourBookingFilterActivity, arrItemsFinal1)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
                    ...
                    val itemAdapter = DialogEmployeeAdapter(this@TourBookingFilterActivity, arrayListEmployee!!)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
