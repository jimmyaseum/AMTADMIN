...
import com.app.amtadminapp.activity.Reports.ReportView.PendingRouteVoucherReportViewActivity
...
import kotlinx.android.synthetic.main.activity_pending_route_voucher_report.*
...
class PendingRouteVoucherReportActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pending_route_voucher_report)
        initializeView()
    }
...
//                dpd.datePicker.maxDate = System.currentTimeMillis() - 1000
            ...
            R.id.CardGetDetail -> {
                val intent = Intent(this, PendingRouteVoucherReportViewActivity::class.java)
                intent.putExtra("DateType", DateTypeName)
        ...
        edtSearchCustomer.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(char: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                if (char.toString().trim().isNotEmpty()) {
                    ...
                    val itemAdapter = DialogTourPackageAdapter(this@PendingRouteVoucherReportActivity, arrItemsFinal1)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
                    ...
                    val itemAdapter = DialogTourPackageAdapter(this@PendingRouteVoucherReportActivity, arrayListTourPackage!!)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
