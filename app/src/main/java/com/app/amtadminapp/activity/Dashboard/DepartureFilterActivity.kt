...
import kotlinx.android.synthetic.main.activity_dashboard_departure_filter.edtBookBy
import kotlinx.android.synthetic.main.activity_dashboard_departure_filter.edtBranch
import kotlinx.android.synthetic.main.activity_dashboard_departure_filter.edtMobileNo
import kotlinx.android.synthetic.main.activity_dashboard_departure_filter.edtName
import kotlinx.android.synthetic.main.activity_dashboard_departure_filter.edtNoOfNights
import kotlinx.android.synthetic.main.activity_dashboard_departure_filter.edtSector
import kotlinx.android.synthetic.main.activity_dashboard_departure_filter.edtTour
import kotlinx.android.synthetic.main.activity_dashboard_departure_filter.edtTourBookingNo
import kotlinx.android.synthetic.main.activity_dashboard_departure_filter.edtTourDateCode
import kotlinx.android.synthetic.main.activity_dashboard_departure_filter.edtTourStartDate
import kotlinx.android.synthetic.main.activity_dashboard_departure_filter.edtTravelType
import kotlinx.android.synthetic.main.activity_dashboard_departure_filter.tvApply
import kotlinx.android.synthetic.main.activity_dashboard_departure_filter.tvClearAll
import kotlinx.android.synthetic.main.activity_dashboard_departure_filter.tvClose
import kotlinx.android.synthetic.main.activity_dashboard_departure_filter.tvFilters
...
class DepartureFilterActivity  : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dashboard_departure_filter)
        getIntentData()
        initializeView()
    }
        ...
        edtSearchCustomer.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(char: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                if (char.toString().trim().isNotEmpty()) {
                    ...
                    val itemAdapter = DialogSectorAdapter(this@DepartureFilterActivity, arrItemsFinal1)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
                    ...
                    val itemAdapter = DialogSectorAdapter(this@DepartureFilterActivity, arrayListSector!!)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
        ...
        edtSearchCustomer.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(char: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                if (char.toString().trim().isNotEmpty()) {
                    ...
                    val itemAdapter = DialogTourPackageAdapter(this@DepartureFilterActivity, arrItemsFinal1)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
                    ...
                    val itemAdapter = DialogTourPackageAdapter(this@DepartureFilterActivity, arrayListTourPackage!!)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
        ...
        edtSearchCustomer.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(char: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                if (char.toString().trim().isNotEmpty()) {
                    ...
                    val itemAdapter = DialogEmployeeAdapter(this@DepartureFilterActivity, arrItemsFinal1)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
                    ...
                    val itemAdapter = DialogEmployeeAdapter(this@DepartureFilterActivity, arrayListEmployee!!)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
