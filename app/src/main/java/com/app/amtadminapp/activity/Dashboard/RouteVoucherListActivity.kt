...
import com.app.amtadminapp.adapter.Dashboard.RouteVoucherListAdapter
import com.app.amtadminapp.model.response.RouteVoucherListModel
import com.app.amtadminapp.model.response.RouteVoucherListResponse
...
class RouteVoucherListActivity : BaseActivity() {

    lateinit var adapter: RouteVoucherListAdapter
    private var arrRouteVoucherList: ArrayList<RouteVoucherListModel> = ArrayList()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_route_voucher_list)
        getIntentData()
        initializeView()
    }
    ...
    override fun initializeView() {
        ...
        imgFilter.setOnClickListener {
            val intent = Intent(this, RouteVoucherFilterActivity::class.java)
            intent.putExtra("RouteVoucherNo", RouteVoucherNo)
        ...
        adapter = RouteVoucherListAdapter(this@RouteVoucherListActivity, arrRouteVoucherList)
    ...
    private fun CallRouteVoucherListAPI() {
        ...
        jsonObject.put("RouteVoucher",RouteVoucherNo.trim())
        ...
        val call = ApiUtils.apiInterface2.GetDashboardRouteVoucherList(getRequestJSONBody(jsonObject.toString()))
        call.enqueue(object : Callback<RouteVoucherListResponse> {
            override fun onResponse(call: Call<RouteVoucherListResponse>, response: Response<RouteVoucherListResponse>) {
...
//                            rvRouteVoucherList.adapter = adapter
            ...
            override fun onFailure(call: Call<RouteVoucherListResponse>, t: Throwable) {
                hideProgress()
        ...
        if (resultCode == Activity.RESULT_OK) {
            when (requestCode) {
                ...
                1000 -> {
                    ...
                    RouteVoucherNo = data!!.getStringExtra("RouteVoucherNo").toString()
