...
import kotlinx.android.synthetic.main.activity_dashboard_pending_form_filter.*
import kotlinx.android.synthetic.main.activity_dashboard_pending_form_filter.edtBookBy
import kotlinx.android.synthetic.main.activity_dashboard_pending_form_filter.edtBranch
import kotlinx.android.synthetic.main.activity_dashboard_pending_form_filter.edtMobileNo
import kotlinx.android.synthetic.main.activity_dashboard_pending_form_filter.edtName
import kotlinx.android.synthetic.main.activity_dashboard_pending_form_filter.edtNoOfNights
import kotlinx.android.synthetic.main.activity_dashboard_pending_form_filter.edtSector
import kotlinx.android.synthetic.main.activity_dashboard_pending_form_filter.edtTour
import kotlinx.android.synthetic.main.activity_dashboard_pending_form_filter.edtTourBookingNo
import kotlinx.android.synthetic.main.activity_dashboard_pending_form_filter.edtTourDateCode
import kotlinx.android.synthetic.main.activity_dashboard_pending_form_filter.edtTourStartDate
import kotlinx.android.synthetic.main.activity_dashboard_pending_form_filter.edtTravelType
import kotlinx.android.synthetic.main.activity_dashboard_pending_form_filter.tvApply
import kotlinx.android.synthetic.main.activity_dashboard_pending_form_filter.tvClearAll
import kotlinx.android.synthetic.main.activity_dashboard_pending_form_filter.tvClose
import kotlinx.android.synthetic.main.activity_dashboard_pending_form_filter.tvFilters
...
class PendingFormFilterActivity  : BaseActivity(), View.OnClickListener {
    ...
    private fun getIntentData() {
        ...
        if (intent.hasExtra("PendingStepFrom")) {
            PendingStepFrom = intent.getStringExtra("PendingStepFrom").toString()
            edtPendingStepFrom.setText(PendingStepFrom)
        }
...
//                dpd.datePicker.maxDate = System.currentTimeMillis() - 1000
    ...
    private fun applyFiltersData() {
        ...
        intent.putExtra("PendingStepFrom",edtPendingStepFrom.text.toString())
        ...
        edtSearchCustomer.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(char: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                if (char.toString().trim().isNotEmpty()) {
                    ...
                    val itemAdapter = DialogSectorAdapter(this@PendingFormFilterActivity, arrItemsFinal1)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
                    ...
                    val itemAdapter = DialogSectorAdapter(this@PendingFormFilterActivity, arrayListSector!!)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
        ...
        edtSearchCustomer.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(char: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                if (char.toString().trim().isNotEmpty()) {
                    ...
                    val itemAdapter = DialogTourPackageAdapter(this@PendingFormFilterActivity, arrItemsFinal1)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
                    ...
                    val itemAdapter = DialogTourPackageAdapter(this@PendingFormFilterActivity, arrayListTourPackage!!)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
        ...
        edtSearchCustomer.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(char: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                if (char.toString().trim().isNotEmpty()) {
                    ...
                    val itemAdapter = DialogEmployeeAdapter(this@PendingFormFilterActivity, arrItemsFinal1)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
                    ...
                    val itemAdapter = DialogEmployeeAdapter(this@PendingFormFilterActivity, arrayListEmployee!!)
                    itemAdapter.setRecyclerRowClick(object : RecyclerClickListener {
                        override fun onItemClickEvent(v: View, pos: Int, flag: Int) {
